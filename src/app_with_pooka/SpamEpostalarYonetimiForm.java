 ...
 * @author Kenan Savas
 */
public class SpamEpostalarYonetimiForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form SpamEpostalarYonetimiForm
     */
    public SpamEpostalarYonetimiForm() {
        initComponents();
        try{
        ...
        if (allRecords!=null){
            String[] tableHeaderArray=new String[]{"Kelime ID","Kelime"}; 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpamEpostalarYonetimiForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SpamEpostalarYonetimiForm().setVisible(true);
            }
        });
    }
