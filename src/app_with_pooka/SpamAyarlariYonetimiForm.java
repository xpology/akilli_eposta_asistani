 ...
 * @author Kenan Savas
 */
public class SpamAyarlariYonetimiForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form SpamAyarlariYonetimiForm
     */
    public SpamAyarlariYonetimiForm() {
        initComponents();
        try{
        ...
        allRecords=getFieldsFromTable("[spam_ayarlar]", 6);
        
        if (allRecords!=null){
            String[] tableHeaderArray=new String[]{"spam_ayarlar_id","spam_ayarlar_hesapid","spam_ayarlar_ayaradi","spam_ayarlar_ayardegeri1","spam_ayarlar_ayardegeri2","spam_ayarlar_ayardegeri3"}; 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpamAyarlariYonetimiForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SpamAyarlariYonetimiForm().setVisible(true);
            }
        });
    }
