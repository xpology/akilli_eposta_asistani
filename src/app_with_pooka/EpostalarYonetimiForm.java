...
import static app_with_pooka.IstatistiklerYonetimiForm.con;
 ...
 * @author Kenan Savas
 */
public class EpostalarYonetimiForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EpostalarYonetimiForm
     */
    public EpostalarYonetimiForm() {
        initComponents();
        try{
        ...
        allRecords=getFieldsFromTable("[epostalar]", 13);        
        String[] tableHeaderArray=new String[]{"epostalar_id","epostalar_dosyano","epostalar_hesapid","epostalar_dizinid","epostalar_baslik","epostalar_iceriktipi","epostalar_icerik","epostalar_kimdenepostaid","epostalar_kimeepostaid","epostalar_zaman","epostalar_eklerid","epostalar_baglantilarid","epostalar_spammi"}; 
        if (allRecords!=null){        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EpostalarYonetimiForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EpostalarYonetimiForm().setVisible(true);
            }
        });
    }
