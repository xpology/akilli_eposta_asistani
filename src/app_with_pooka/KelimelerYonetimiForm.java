...
import static app_with_pooka.MainForm.con;
 ...
 * @author Kenan Savas
 */
public class KelimelerYonetimiForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form KelimelerYpnetimiForm
     */
    public KelimelerYonetimiForm() {
        initComponents();
        try{
        ...
        if (allRecords!=null){
            String[] tableHeaderArray=new String[]{"kelimeler_id","kelimeler_kelime"}; 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KelimelerYonetimiForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KelimelerYonetimiForm().setVisible(true);
            }
        });
    }
